...
<tr><th align='right' valign='middle'>Password:</th><td><input type='password' name='password' id='password'></td></tr>
<tr><th align='right' valign='middle'>Confirm Password:</th><td><input type='password' name='conpassword' id='conpassword'></td></tr>
...
<tr><th align='right' valign='middle'>Date of Birth:</th>
<!--<td><input type='date'></td>-->
<td><select name='dob_dd'>
...
<tr><td></td><td align='left'><br><input type='submit' value='REGISTER' style="background-color:green; color:#ffffff; padding:5px; font-weight: bold;"></td></tr>
</table>
</form>
</CENTER>
